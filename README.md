*place_search_google.py* returns a dataframe of names and addresses of places of interest (e.g, restaurants, grocery stores, schools etc.) as defined by the parameter **keyword**.
